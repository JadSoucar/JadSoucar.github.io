...
$$P_{(O,D)}=\{\pi=(\pi_1,\pi_2,\dots,\pi_{n-1},\pi_n):\pi_1=O,\pi_n=D,$$
$$\quad \quad \quad (\pi_i,\pi_{i+1})\in E \quad \forall i=1,\dots,n-1 \}.$$
...
$$J_{soc}(f)=x_1c_{x_1}(x_1) + x_2c_{x_2}(x_2) = x_1 + x_2^2 \quad \text{s.t} \quad f_{(1)} + f_{(2)}=1$$
